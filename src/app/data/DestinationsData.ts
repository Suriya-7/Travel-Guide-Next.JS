export const destinations = [
  ...
  },
  {
    ...
    details: {
      ...
      visaRequired: ["India", "China", "Russia"],
      visaNotRequired: ["UK", "EU countries", "USA"],
    },
  },
  {
    name: "Rome",
    overview:
      "Rome, the capital of Italy, is an ancient city full of history, art, and iconic monuments like the Colosseum and Roman Forum.",
    thingsToDo: [
      "Visit the Colosseum",
    ...
    bestSeason: "April to June and September to November",
    famousLocalFood: ["Pasta", "Pizza", "Tiramisu", "Gelato"],
    localCurrency: "Euro (€)",
    bestPlacesToVisit: [
      "Colosseum",
      "Roman Forum",
    ...
    imageUrl: "/Destination/Rome/Rome.jpg",
    Overviewimg: "/Destination/Rome/Rome1.jpg",
    localimg: "/Destination/Rome/Rome2.jpg",
    Foodimg: "/Destination/Rome/Rome3.jpg",
    link: "/explore/rome",
    details: {
      nativeLanguage: "Italian",
      visaRequired: ["India", "China", "Russia"],
